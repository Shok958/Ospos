...
<head>
	...
	<?php else : ?>
		...
		<link rel="stylesheet" type="text/css" href="dist/opensourcepos.min.css?rel=b4134a709a"/>

		<!-- end mincss template tags -->
		<!-- start minjs template tags -->

		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=16ad5f41e1"></script>
